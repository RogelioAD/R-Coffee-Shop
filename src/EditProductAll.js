...
function EditProductAll() {
  ...
  useEffect(() => {
    ...
    async function fetch() {
      await getProductId(id).then((product) => setProduct(product));
    }
    fetch();
  }, [id]);
  ...
  function handleSubmit(event) {
    ...
    if (lastSegment === "edit-all" || lastSegment === "view-edit-all") {
      navigate("/view-all");
    }
  }
