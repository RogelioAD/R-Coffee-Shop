    ...
    return (
        <div className='m-5' style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ flex: 3, marginRight: '10px' }}>
                <img className="aboutimg" style={{ width: "100%" }} src={'https://www.luxcafeclub.com/cdn/shop/articles/Minimalist_Modern_Coffee_Shop_1_1100x.png?v=1713243107'} alt="Rogelios Coffee Shop" />
            </div>
